...
/******/
/******/
/******/ 	// expor o objeto de módulos (__webpack_modules__)
...
/******/
/******/ 	// Carrega módulo de entrada e retorna exportações
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.addUfo = function(ctx) {
	  // Retorno antecipado se um OVNI estiver atualmente gerado
	  if (this.ufo) { return; }
	...
	// Este método faz com que as naves inimigas disparem balas
	Game.prototype.enemyFire = function() {
	  // fireChance aumenta à medida que a horda é eliminada
	  ...
	  // Retorno antecipado se o OVNI não for gerado
	...
	// Este método faz com que as naves inimigas se movam mais rápido a cada uma que morre
	    ...
	    for (var j = 0; j < collisionObjects.length; j++) {
	      ...
	      if (Util.validCollision(options)) {
	        if (object1.isCollidedWith(object2)) {
	          // collideWith manipula a lógica para remover objetos da tela
...
/***/ function(module, exports, __webpack_require__) {
	...
	Ship.prototype.draw = function(ctx) {
	  ...
	  // subtrai de pos para alinhar a imagem com o raio
	  let x = this.pos[0] - 12;
	  let y = this.pos[1] - 12;
	...
	Ship.prototype.fireBullet = function() {
	  /*
	  	O retorno antecipado impede que o jogador envie balas repetidamente, limitando o jogador a uma bala por vez.
	  */
	...
	Ship.prototype.move = function() {
	  ...
	  // O jogador perde o jogo se os invasores se aproximarem muito do fundo
