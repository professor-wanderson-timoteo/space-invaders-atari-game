...
const closeAboutClass = document.getElementById('closeAbout');
...
const invaderInfo = document.getElementById('info');
const audio = document.getElementById('audio');
const mute = document.getElementById('audio');
